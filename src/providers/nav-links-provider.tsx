...
const DEFAULT_NAV_LINKS: NavLink[] = [
  { id: "default-live", title: "Live", url: "/live", order: 1 },
  { id: "default-community", title: "Community", url: "/community", order: 2 },
  { id: "default-certificates", title: "My Certificates", url: "/my-certificates", order: 3 },
];
...
export function NavLinksProvider({ children }: { children: React.ReactNode }) {
  ...
  const fetchNavLinks = useCallback(async () => {
    ...
    try {
      ...
      // If empty, keep DEFAULT_NAV_LINKS
    } catch (error) {
