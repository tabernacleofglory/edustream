...
import { ArrowRight, Settings, Shield, Link as LinkIcon, Award, Sparkles, Lock, Globe, Code } from "lucide-react";
...
const tools = [
  ...
  {
    title: "Code Manager",
    description: "Manage third-party scripts, such as the Tawk.to live chat.",
    href: "/admin/developer/code-manager",
    icon: Code,
    permission: 'developer'
  },
  {
