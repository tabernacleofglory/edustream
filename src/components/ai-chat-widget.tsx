                ...
                >
                  ...
                  >
                    {msg.role === "user" ? (
                      ...
                      <div className="prose prose-sm max-w-none dark:prose-invert [&_a]:text-blue-500 [&_a]:underline [&_a]:hover:text-blue-700 [&_ul]:list-disc [&_ul]:pl-4 [&_ol]:list-decimal [&_ol]:pl-4 [&_p]:mb-1 [&_p:last-child]:mb-0">
