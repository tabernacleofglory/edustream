...
export default function AnalyticsDashboard() {
  ...
  const fetchSummaryData = useCallback(async () => {
    ...
    videoProgressSnap.forEach(d => {
        ...
        data.videoProgress?.forEach((vp: any) => { if(vp.completed) videoDoneMap.get(data.userId)!.add(vp.videoId); });
    });
    ...
    // Sycn granular maps with global model too for maximum accuracy
                  ...
                  <>
                      ...
                      <Card>
                          ...
                          <CardContent>
                            ...
                            <p className="text-[10px] text-muted-foreground mt-1">Verified via multi-source process</p>
                          </CardContent>
                      </Card>
                      <Card className="sm:col-span-2 md:col-span-1">
                          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <div className="grid gap-4 mt-6 grid-cols-1 md:grid-cols-2">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Students who completed all courses in their assigned ladder. Click for details.</CardDescription>
                    </CardHeader>
                    <CardContent className="h-[300px]">
