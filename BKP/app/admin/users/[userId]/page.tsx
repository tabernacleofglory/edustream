...
import { collection, query, where, doc, getDoc, getDocs, documentId, collectionGroup, Timestamp, setDoc, serverTimestamp, updateDoc } from 'firebase/firestore';
import { useToast } from '@/hooks/use-toast';
import { Card, CardHeader, CardTitle, CardDescription, CardContent } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Loader2, ArrowLeft, Mail, Edit, Eye, CheckCircle, Circle, Trash, UserMinus, RefreshCw, Info } from 'lucide-react';
import { Avatar, AvatarImage, AvatarFallback } from '@/components/ui/avatar';
import type { Course, User, Enrollment, UserProgress, Ladder, UserLadderProgress, Video, UserQuizResult } from '@/lib/types';
...
export default function UserProfilePage() {
  ...
  const fetchUserData = useCallback(async () => {
    ...
    try {
      ...
      // === Multi-Source Verification Data Fetching ===
      ...
      // --- Logic for Course Completion (Multi-Source) ---
      ...
      // 4. FALLBACK GRANULAR VERIFICATION
      ...
      const detailedCourseProgress = enrolledCourseIds
        .map(cid => {
          ...
          const totalProgress = allCompletedCourseIds.has(c.id) ? 100 : (storedProgress !== undefined ? storedProgress : (totalVideos > 0 ? Math.round((completedVideosCount / totalVideos) * 100) : 0));
          ...
          <div className="lg:col-span-2 space-y-8">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Reconcile legacy progress records with the new global system. This process is handled securely on the server.</CardDescription>
                </CardHeader>
